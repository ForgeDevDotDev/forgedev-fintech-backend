...
> Backend API for the Fintech domain — transactions, accounts, balances, audit logs
...
Backend API for the **Fintech** domain. Serves these frontends:

| Repo | Framework |
|------|-----------|
| forgedev-fintech-react | React |
| forgedev-fintech-vue | Vue |
